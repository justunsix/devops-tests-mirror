...
```
cd existing_repo
git remote add origin https://gitlab.com/justunsix/devops-tests.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/justunsix/devops-tests/-/settings/integrations)
